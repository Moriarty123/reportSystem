<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"F:\study\www\reportSystem\ThinkPHP\public/../app/teacher\view\guide\guideUpdate.html";i:1554033713;s:35:"../app/common/view/html/header.html";i:1554022704;s:36:"../app/teacher/view/common/menu.html";i:1554022704;s:35:"../app/common/view/html/footer.html";i:1548946076;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="container" style="margin-top:20px; height: 500px;">
    ...
    <div id="MainForm">
        <div class="form_boxA">
            ...
            <form action="/teacher/guide/guideUpdate" method="post" onsubmit="return checkSubmit()">
                <input type="hidden" name="guideNo" value="<?php echo $guide['guideNo']; ?>">
                <div>
                    <input type="text" name="guideName" id="guideName" style="width: 100%; margin-bottom: 5px; padding-left: 5px;" value="<?php echo $guide['guideName']; ?>"></div>
                <div>
...
<script type="text/javascript" language="javascript">
        ...
        // console.log("<?php echo $txtContent; ?>");
