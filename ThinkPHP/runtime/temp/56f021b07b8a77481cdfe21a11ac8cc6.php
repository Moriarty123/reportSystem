<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\study\www\reportSystem\ThinkPHP\public/../app/student\view\report\reportEditor.html";i:1554107673;s:35:"../app/common/view/html/header.html";i:1554052431;s:35:"../app/common/view/html/footer.html";i:1554052431;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<script type="text/javascript" language="javascript">
        ...
        function pageInit()
        {
			...
			guideeditor.setSource('<?php echo $txtContent; ?>');

        }

        // alert('<?php echo $txtContent; ?>');
