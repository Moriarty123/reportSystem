!function(e, t) {
    ...
    m.prototype = {
        ...
        _insertLink: function(e, t) {
            ...
            !0 === A ? n.cmd.do("insertHTML", '<a href="' + t + '" target="_blank">' + e + "</a>") : alert(A)
        },
        tryChangeActive: function(e) {
            var t = this.editor
              , n = this.$elem
                ...
                if (w || o || c) {
                    ...
                    if (r(e, function(e) {
                        var t = e.name
                          , n = e.size;
                        if (t && n)
                            return !1 === /\.(jpg|jpeg|png|bmp|gif|webp)$/i.test(t) ? void E.push("【" + t + "】不是图片") : a < n ? void E.push("【" + t + "】大于 " + s + "M") : void v.push(e)
                    }),
                    E.length)
